#!/bin/bash
# UserPromptSubmit hook: prevent Mac idle sleep during Claude Code sessions.
# Uses per-session marker files ($PPID) to support multiple concurrent sessions.
# Based on https://dev.ngockhuong.com/posts/preventing-mac-sleep-during-claude-code-sessions/
